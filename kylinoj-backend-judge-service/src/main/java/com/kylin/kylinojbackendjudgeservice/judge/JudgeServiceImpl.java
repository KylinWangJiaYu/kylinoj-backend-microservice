...
import com.kylin.kylinoijbackendserviceclient.service.QuestionService;
import com.kylin.kylinoijbackendserviceclient.service.QuestionSubmitService;
...
import com.kylin.kylinojbackendjudgeservice.judge.codesandbox.CodeSandboxFactory;
import com.kylin.kylinojbackendjudgeservice.judge.codesandbox.CodeSandboxProxy;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        //4）调用代码沙箱，获取执行结果
        CodeSandbox codeSandbox = CodeSandboxFactory.newInstance(type);//从配置中获取代码沙箱
        ...
        System.out.println("judgeserviceimpl得到的judgeinfo："+judgeInfo);
        //6)修改数据库中的判题结果
